...
namespace SharpLab.Server.Compilation {
    public class Compiler : ICompiler {
        ...
        private bool TryCompileILToStream(MemoryStream assemblyStream, IWorkSession session, IList<Diagnostic> diagnostics) {
            ...
            try {
                Encoding.UTF8.GetBytes(ilText, 0, ilText.Length, sourceBytes, 0);
                using var sourceStream = (RecyclableMemoryStream)_memoryStreamManager.GetStream("Compiler-IL", sourceBytes, 0, sourceBytesLength);

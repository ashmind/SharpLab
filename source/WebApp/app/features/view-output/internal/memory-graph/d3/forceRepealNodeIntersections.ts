import type { ExtendedNodeDatum, NodeRect, TopLevelNodeDatumData } from '../types';

const applyForceIfIntersecting = (
...
export const forceRepealNodeIntersections = (getNodeRect: (node: ExtendedNodeDatum) => NodeRect) => {

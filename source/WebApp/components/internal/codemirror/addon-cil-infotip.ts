...
const instructions = {
    ...
    'arglist': 'Return argument list handle for the current method (0xFE 00)',
    ...
    'ceq': 'Push 1 (of type int32) if value1 equals value2, else push 0 (0xFE 01)',
    'cgt': 'Push 1 (of type int32) if value1 > value2, else push 0 (0xFE 02)',
    'cgt.un': 'Push 1 (of type int32) if value1 > value2, unsigned or unordered, else push 0 (0xFE 03)',
    'ckfinite': 'Throw ArithmeticException if value is not a finite number (0xC3)',
    'clt': 'Push 1 (of type int32) if value1 < value2, else push 0 (0xFE 04)',
    'clt.un': 'Push 1 (of type int32) if value1 < value2, unsigned or unordered, else push 0 (0xFE 05)',
    'constrained': 'Call a virtual method on a type constrained to be type T (0xFE 16<T>)',
    ...
    'cpblk': 'Copy data from memory to memory (0xFE 17)',
    ...
    'endfault': 'End fault clause of an exception block (alias for endfilter) (0xFE 11)',
    'endfilter': 'End an exception handling filter clause (0xFE 11)',
    'endfinally': 'End finally clause of an exception block (0xDC)',
    'initblk': 'Set all bytes in a block of memory to a given byte value (0xFE 18)',
    'initobj': 'Initialize the value at address dest (0xFE 15<T>)',
    ...
    'ldarg': 'Load argument numbered num onto the stack (0xFE 09<uint16>)',
    ...
    'ldarga': 'Fetch the address of argument argNum (0xFE 0A<uint16>)',
    ...
    'ldftn': 'Push a pointer to a method referenced by method, on the stack (0xFE 06<T>)',
    ...
    'ldloc': 'Load local variable of index indx onto stack (0xFE 0C<uint16>)',
    ...
    'ldloca': 'Load address of local variable with index indx (0xFE 0D<uint16>)',
    ...
    'ldvirtftn': 'Push address of virtual method on the stack (0xFE 07<T>)',
    'leave': 'Exit a protected region of code (0xDD<int32>)',
    'leave.s': 'Exit a protected region of code, short form (0xDE<int8>)',
    'localloc': 'Allocate space from the local memory pool (0xFE 0F)',
    ...
    'refanytype': 'Push the type token stored in a typed reference (0xFE 1D)',
    ...
    'rethrow': 'Rethrow the current exception (0xFE 1A)',
    ...
    'sizeof': 'Push the size, in bytes, of a type as an unsigned int32 (0xFE 1C<T>)',
    'starg': 'Store value to the argument numbered num (0xFE 0B<uint16>)',
    ...
    'stloc': 'Pop a value from stack into local variable index (0xFE 0E<uint16>)',
    ...
    'tail': 'Subsequent call terminates current method (0xFE 14)',
    'throw': 'Throw an exception (0x7A)',
    'unaligned': 'Subsequent pointer instruction might be unaligned (0xFE 12)',
    ...
    'volatile': 'Subsequent pointer reference is volatile (0xFE 13)',
